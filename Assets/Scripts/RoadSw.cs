...
public class RoadSw : MonoBehaviour
{
  public GameObject [] Prefabs;
	...
	private float BackArea = 200.0f;
	private int PrefabsOnScreen = 4;
	private int LastPrefab = 0;
	private float SpawnPrefab = -100.0f;
	private float PrefabLength = 99.0f;
